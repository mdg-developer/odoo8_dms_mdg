...
class employee_efficiency_value_info(osv.osv):
    ...
    def import_data(self, cr, uid, ids, context=None):
        ...
        hr_fine_obj = self.pool.get('hr.fine')
        ...
        # if amls :    
            for aml in amls:
                ...
                if aml['code']:
                    ...
                    code = None
                if reason and code:
                    cr.execute('select id from hr_fine_reason where name=%s and code=%s',(reason,code.upper(),))
                    reason_id = cr.fetchall()    
                ...
                if emp_ids:
                    ...
                    cr.execute("delete from hr_fine where lost_date =%s  and employee_id =%s and reason_id=%s",(date,emp_ids[0],reason_id[0],))          
                    hr_fine_obj.create(cr, uid, {
