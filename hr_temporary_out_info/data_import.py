...
header_fields = ['fingerprint_id', 'badge_id', 'date', 'out_time', 'in_time', 'duration', 'reason']

class employee_temporary_out_info(osv.osv):
    _name = 'data_import.temporary_out_info'
    _columns = {
    ...
    def import_data(self, cr, uid, ids, context=None):
        ...
        hr_temporary_obj = self.pool.get('hr.temporary.out')
...
#                 else:
                if ln:
                    ...
                    fingerprint_id_i = badge_id_i = date_i = out_time_i = in_time_i = temporary_duration_i = reason_i = None
                    column_cnt = len(ln)
                    ...
                    for i in range(column_cnt):
                        ...
                        # required header fields : account, debit, credit
                            ...
                            date_i = i
                        elif header_field == 'out_time':
                            out_time_i = i                          
                        elif header_field == 'in_time':
                            in_time_i = i                               
                        elif header_field == 'duration':
                            temporary_duration_i = i                                 
                ...
                if ln and ln not in ['#', '']:
                    ...
                    import_vals['out_time'] = ln[out_time_i]
                    import_vals['in_time'] = ln[in_time_i]
                    import_vals['duration'] = ln[temporary_duration_i]
                    import_vals['temporary_duration'] = ln[temporary_duration_i]
        ...
        # if amls :    
            for aml in amls:
                ...
                fingerprint_id = badge_id = date = out_time = in_time = duration = reason = None
                value = {}
                ...
                if emp_ids:
                    ...
                    hr_temporary_obj.create(cr, uid, {
