...
class stock_quant(osv.osv):
    ...
    def _account_entry_move(self, cr, uid, quants, move, context=None):
        ...
        if move.id != True and stock_picking is not None:    
            move_obj.write(cr, uid, move.id, {'branch_id':stock_picking.branch_id.id,'date':stock_picking.date,}, context=context)
            cr.execute('update account_move_line set branch_id=%s where move_id =%s ', (stock_picking.branch_id.id ,move.id,))            