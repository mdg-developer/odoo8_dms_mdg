...
class res_partner(orm.Model):
    ...
    # override list in custom module to add/drop columns or change order of the partner summary table
    ...
    def _report_xls_arap_details_fields(self, cr, uid, context=None):
        return [
            'document', 'date', 'date_maturity', 'account', 'description', 'rec_or_rec_part',
