...
# /api/res.country.state                GET     - Read all (with optional filters, offset, limit, order, exclude_fields, include_fields)
# /api/res.country.state/<id>           GET     - Read one (with optional exclude_fields, include_fields)
...
#           "results": [
OUT__res_country_state__read_all__SCHEMA = (                 # editable
    'id',
    'name',
    'code',
    ('country_id', (
...
OUT__res_country_state__read_one__SCHEMA = (                 # editable
...
DEFAULTS__res_country_state__create_one__JSON = {          # editable
...
OUT__res_country_state__create_one__SCHEMA = (               # editable
    'id',
)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/res.country.state', methods=['GET'], type='http', auth='none')
    @check_permissions
    def api__res_country_state__GET(self, **kw):
        return wrap__resource__read_all(
            ...
            OUT_fields = OUT__res_country_state__read_all__SCHEMA
        )
    
    # Read one (with optional exclude_fields, include_fields):
    @http.route('/api/res.country.state/<id>', methods=['GET'], type='http', auth='none')
    @check_permissions
    def api__res_country_state__id_GET(self, id, **kw):
        return wrap__resource__read_one(
            ...
            OUT_fields = OUT__res_country_state__read_one__SCHEMA
        )
    
    # Create one:
    @http.route('/api/res.country.state', methods=['POST'], type='http', auth='none', csrf=False)
    @check_permissions
    def api__res_country_state__POST(self, **kw):
        return wrap__resource__create_one(
            ...
            OUT_fields = OUT__res_country_state__create_one__SCHEMA
        )
    
    # Update one:
    @http.route('/api/res.country.state/<id>', methods=['PUT'], type='http', auth='none', csrf=False)
    @check_permissions
    def api__res_country_state__id_PUT(self, id, **kw):
    ...
    # Delete one:
    @http.route('/api/res.country.state/<id>', methods=['DELETE'], type='http', auth='none', csrf=False)
    @check_permissions
    def api__res_country_state__id_DELETE(self, id, **kw):
    ...
    @http.route('/api/res.country.state/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False)
    @check_permissions
    def api__res_country_state__id__method_PUT(self, id, method, **kw):
