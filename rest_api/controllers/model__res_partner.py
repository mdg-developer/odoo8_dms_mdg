...
OUT__res_partner__read_one__SCHEMA = (                # editable
...
OUT__res_partner__create_one__SCHEMA = (              # editable
    'id',
    'name',
    ('country_id', (
        'code',
...
class ControllerREST(http.Controller):
    ...
    def api__res_partner__GET(self, **kw):
        return wrap__resource__read_all(
            ...
            OUT_fields = OUT__res_partner__read_all__SCHEMA
        )
    ...
    def api__res_partner__id_GET(self, id, **kw):
        return wrap__resource__read_one(
            ...
            OUT_fields = OUT__res_partner__read_one__SCHEMA
        )
    ...
    def api__res_partner__POST(self, **kw):
        return wrap__resource__create_one(
            ...
            OUT_fields = OUT__res_partner__create_one__SCHEMA
        )
