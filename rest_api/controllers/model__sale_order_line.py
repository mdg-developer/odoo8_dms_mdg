...
#           "results": [
OUT__sale_order_line__read_all__SCHEMA = (            # editable
    'id',
    'order_id',
    ('product_id', (  # many2one
        'id',
...
OUT__sale_order_line__read_one__SCHEMA = (            # editable
...
OUT__sale_order_line__create_one__SCHEMA = (          # editable
    'id',
)
...
class ControllerREST(http.Controller):
    ...
    def api__sale_order_line__GET(self, **kw):
        return wrap__resource__read_all(
            ...
            OUT_fields = OUT__sale_order_line__read_all__SCHEMA
        )
    ...
    def api__sale_order_line__id_GET(self, id, **kw):
        return wrap__resource__read_one(
            ...
            OUT_fields = OUT__sale_order_line__read_one__SCHEMA
        )
    ...
    def api__sale_order_line__POST(self, **kw):
        return wrap__resource__create_one(
            ...
            OUT_fields = OUT__sale_order_line__create_one__SCHEMA
        )
