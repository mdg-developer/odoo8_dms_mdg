...
#           "results": [
OUT__sale_order__read_all__SCHEMA = (                 # editable
...
OUT__sale_order__read_one__SCHEMA = (                 # editable
...
OUT__sale_order__create_one__SCHEMA = (               # editable
    'id',
)
...
class ControllerREST(http.Controller):
    ...
    def api__sale_order__GET(self, **kw):
        return wrap__resource__read_all(
            ...
            OUT_fields = OUT__sale_order__read_all__SCHEMA
        )
    ...
    def api__sale_order__id_GET(self, id, **kw):
        return wrap__resource__read_one(
            ...
            OUT_fields = OUT__sale_order__read_one__SCHEMA
        )
    ...
    def api__sale_order__POST(self, **kw):
        return wrap__resource__create_one(
            ...
            OUT_fields = OUT__sale_order__create_one__SCHEMA
        )
