...
ATTRIBUTES = [
    ...
    ('prod_liter_conbin', 'Product Liter  combination'),
]
...
ACTION_TYPES = [
  ...
  #  ('cart_disc_perc', _('Discount % on Sub Total')),
   ...
   # ('foc_on_categ', _('FOC on Product Category')),
    ...
    ('fix_amt_on_grand_total_ratio', _('Fix Amount on Grand Total by ratio (for viss)')),
    ('fix_amt_on_grand_total_ratio_liter', _('Fix Amount on Grand Total by ratio (for Liter)')),
]
...
#kzo
        ...
        if action_type in ['fix_amt_on_grand_total_ratio_liter', ] :
            return{
                   'value' : {
                              'arguments':"1:0.00",
                              }
