...
#                 rental_collection.append(r)  
    ...
    def dayplan_is_update(self, cr, uid, late_date , context=None, **kwargs):
    ...
    def product_is_update(self, cr, uid, late_date , context=None, **kwargs):
