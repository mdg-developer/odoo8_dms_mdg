...
class account_financial_report_branch(osv.osv_memory):
    _name = "account.financial.report.branch"
    _inherit = "accounting.report"
    _description = "Accounting Report"

    _columns = {
       
        'branch_ids': fields.many2many('res.branch', 'account_financial_report_branch_rel', 'account_id', 'branch_id', 'Branches'),
