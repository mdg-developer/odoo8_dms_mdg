...
class change_product_quantity(osv.osv_memory):
    _name = 'change.product.quantity'
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if context is None:
            context = {}
        res = super(change_product_quantity, self).default_get(cr, uid, fields, context=context)
