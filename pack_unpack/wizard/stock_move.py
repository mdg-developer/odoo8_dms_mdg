...
#--------------------------------------TO SHOW CONSUMED PRODUCTS IN PRODUCT.PACKING FORM------------------------------------------------
class stock_move_consume_product(osv.osv_memory):
    _name = "stock.move.consume.product"
    ...
    def default_get(self, cr, uid, fields, context=None):
        if context is None:
            context = {}
        res = super(stock_move_consume_product, self).default_get(cr, uid, fields, context=context)
