...
class AccountAgedTrialBalance(orm.TransientModel):
    ...
    _columns = {
        ...
        'period_to': fields.many2one('account.period', 'End Period',
                                     required=True),               
        'analytic_account_ids': fields.many2many('account.analytic.account', 'aged_trial_balance_webkit_account_analytic_account','aged_trial_balance_webkit_id','account_analytic_account_id', string='Filter on analytic accounts',
        ...
        'account_ids': fields.many2many('account.account', 'account_aged_trial_balance_webkit_account_account','account_aged_trial_balance_webkit_id','account_id', string='Filter on accounts',
