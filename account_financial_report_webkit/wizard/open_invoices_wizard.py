...
class AccountReportOpenInvoicesWizard(orm.TransientModel):
    ...
    _columns = {
        ...
        'analytic_account_ids': fields.many2many('account.analytic.account', 'open_invoices_webkit_account_analytic_account','open_invoices_webkit_id','account_analytic_account_id', string='Filter on analytic accounts',
...
#             print all accounts."),
        'account_ids': fields.many2many('account.account', 'open_invoices_webkit_account_account','open_invoices_webkit_id','account_id', string='Filter on accounts',
                                         help="Only selected accounts will be printed. Leave empty to \
            print all accounts."),                   
                }
    ...
    def pre_print_report(self, cr, uid, ids, data, context=None):
        ...
        vals = self.read(cr, uid, ids,
                         ['until_date', 'group_by_currency','branch_id','branch_ids','analytic_account_ids','account_ids'],
                         context=context)[0]
