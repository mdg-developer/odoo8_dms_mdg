...
class GeneralLedgerWebkit(report_sxw.rml_parse, CommonReportHeaderWebkit):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        new_analytic_account_ids = data['form']['analytic_account_ids'] 
        ...
        #branch = self._get_form_param('branch_id', data)
...
#                 accounts, new_analytic_account_ids, branch, start, fiscalyear)
            ...
            init_balance_memoizer = self._read_opening_balance(accounts, new_analytic_account_ids, start)
        ...
        self.localcontext.update({
            ...
            'analytic_account_ids':new_analytic_account_ids,   
            'branch_ids':branch,
        })
    ...
    def _compute_account_ledger_lines(self, accounts_ids, new_analytic_account_ids,
                                      init_balance_memoizer, main_filter,
                                      target_move, start, stop,branch):
        res = {}
