...
class HeaderFooterTextWebKitParser(webkit_report.WebKitParser):
    ...
    def create_single_pdf(self, cursor, uid, ids, data, report_xml,
        ...
        if report_xml.report_file:
            if report_xml.report_file == 'account_financial_report_webkit/report/templates/aged_open_invoices.mako':
                if os.environ.get('OS')=='Windows_NT':
                    str = 'account_financial_report_webkit/report/templates/aged_open_invoices.mako'
                    resource_path = str.replace('/','\\')
                    report_xml.report_file = resource_path
                    #mod_path = mod_path.replace(module,'')
