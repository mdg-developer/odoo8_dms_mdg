...
class PartnersOpenInvoicesWebkit(report_sxw.rml_parse,
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        accounts = self._get_form_param('account_ids', data)
        ...
        if accounts:
            account_ids = self.get_all_accounts(
                accounts, exclude_type=['view'], only_type=filter_type)
        else:        
            account_ids = self.get_all_accounts(
        ...
        ledger_lines_memoizer = self._compute_open_transactions_lines(
            account_ids, analytic_account_ids, main_filter, target_move,branch_id, start, stop, date_until,
    ...
    def _compute_open_transactions_lines(self, accounts_ids, analytic_account_ids, main_filter,
        ...
        for account_id in accounts_ids:
            ...
            move_line_ids_per_partner = self.get_partners_move_lines_ids(
                account_id, analytic_account_ids, main_filter, start, stop, target_move,branch_id,
