...
class stock_return_line(osv.osv):  # #prod_pricelist_update_line
    ...
    _columns = {                
        ...
        'onhand_quantity' : fields.float(string='Theorectical Qty', digits=(16, 0)),
        'actual_quantity' : fields.float(string='Actual Qty', digits=(16, 0)),
        'return_quantity' : fields.float(string='Return Qty', digits=(16, 0)),
        'closing_quantity':fields.float(string='Closing Qty', digits=(16, 0)),
