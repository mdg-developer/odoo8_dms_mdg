...
class product_maingroup(osv.osv):
    ...
    _columns = {
                ...
                'property_account_payable': fields.many2one('account.account', 'Account Payable Control' , domain="[('type', '=', 'payable')]", help="This account will be used instead of the default one as the payable account for the current partner", required=True),
                'property_account_receivable': fields.many2one('account.account', 'Account Receivable Control' , domain="[('type', '=', 'receivable')]", help="This account will be used instead of the default one as the receivable account for the current partner", required=True),
                ...
                'property_account_payable_clearing': fields.many2one('account.account', 'Account Payable' , domain="[('type', '=', 'payable')]", help="This account will be used instead of the default one as the payable account for the current partner", required=True),
                'property_account_receivable_clearing': fields.many2one('account.account', 'Account Receivable' , domain="[('type', '=', 'receivable')]", help="This account will be used instead of the default one as the receivable account for the current partner", required=True),                
