...
<META name="viewport" content="width=device-width, initial-scale=1">     <!-- To set pgAdmin4 shortcut icon in browser --> 
    ...
    <LINK href="Average_time_spent_per_outlet_visit_in_minutes_report_files/style.css" 
rel="stylesheet" type="text/css">     <LINK href="Average_time_spent_per_outlet_visit_in_minutes_report_files/pgadmin.style.css" 
rel="stylesheet" type="text/css">     <LINK href="Average_time_spent_per_outlet_visit_in_minutes_report_files/pgadmin.css" 
rel="stylesheet" type="text/css">      <!--View specified stylesheets-->     
<LINK href="Average_time_spent_per_outlet_visit_in_minutes_report_files/browser.css" 
...
<SCRIPT src="Average_time_spent_per_outlet_visit_in_minutes_report_files/require.min.js" type="text/javascript"></SCRIPT>
...
<SCRIPT src="Average_time_spent_per_outlet_visit_in_minutes_report_files/vendor.main.js" type="text/javascript"></SCRIPT>
     
<SCRIPT src="Average_time_spent_per_outlet_visit_in_minutes_report_files/vendor.others.js" type="text/javascript"></SCRIPT>
     
<SCRIPT src="Average_time_spent_per_outlet_visit_in_minutes_report_files/pgadmin_commons.js" type="text/javascript"></SCRIPT>
