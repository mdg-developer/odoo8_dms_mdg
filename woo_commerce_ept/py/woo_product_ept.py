            ...
            if woo_template.woo_brand_id:
                ...
                if woo_brand:
                    if not woo_brand.woo_brand_id:
                        woo_brand_name = woo_brand.woo_brand_id.name
                        woo_description = woo_brand.woo_brand_id.description
                        ...
                        if response:
                            ...
                            if woo_brand_id:
                                ...
                                data.update({'brand_id':woo_brand_id})

            if woo_template.woo_supplier_id:
                woo_supplier = woo_template.woo_supplier_id
                if woo_supplier:
                    if not woo_supplier.woo_supplier_id:
                        woo_supplier_name = woo_supplier.woo_supplier_id.name
                        woo_description = woo_supplier.woo_supplier_id.description
                        ...
                        if response:
                            ...
                            if woo_supplier_id:
                                ...
                                data.update({'supplier_id':woo_supplier_id})

            if woo_template.woo_department_id:
                woo_department = woo_template.woo_department_id
                if woo_department:
                    if not woo_department.woo_department_id:
                        woo_department_name = woo_department.woo_department_id.name
                        woo_description = woo_department.woo_department_id.description
                        ...
                        if response:
                            ...
                            if woo_department_id:
                                woo_supplier.write({'woo_department_id': woo_department_id, 'exported_in_woo': True, 'slug':slug})
                                data.update({'department_id':woo_department_id})
