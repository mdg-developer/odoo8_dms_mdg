...
class WooCoupons(models.Model):
    ...
    email_restrictions = fields.Char("Email restrictions",help="Enter Email Ids which not will be able to use Coupon Code, Enter Email ids Sepreated by(,)",default="")
    ...
    def export_coupons(self,instance,woo_coupons):
        ...
        for woo_coupon in woo_coupons:
            ...
            row_data = {'code': woo_coupon.code,
                        ...
                        'expiry_date':woo_coupon.expiry_date or '',
                        ...
                        'exclude_product_ids':woo_product_exclude_tmpl_ids,
