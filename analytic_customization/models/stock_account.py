...
class stock_quant(osv.osv):
    ...
    def _prepare_account_move_line(self, cr, uid, move, qty, cost, credit_account_id, debit_account_id, context=None):
        ...
        if p_code =='incoming':
            if origin:
                cr.execute ('select analytic_account_id from product_template pt,product_category pc,product_product pp where pt.categ_id=pc.id and pp.product_tmpl_id=pt.id and pp.id=%s',(move.product_id.id,))
                po_name=cr.fetchall()
