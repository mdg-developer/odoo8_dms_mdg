...
class accounting_report(osv.osv_memory):
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return self.pool['report'].get_action(cr, uid, [], 'account_financial_report_xls.report_financial_cust', data=data, context=context)
    ...
    def print_xls_report(self, cr, uid, ids, context=None):     
        ...
        return {'type': 'ir.actions.report.xml',
            ...
            'datas': data}
       # return self.pool['report'].get_action(cr, uid, [], 'account.trial.balance.period.xls', data=data, context=context)
