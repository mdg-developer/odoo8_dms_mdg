...
-- Function: financial_report_balance_analytic_usd(integer, integer, date, date, integer, integer, text, integer)

-- DROP FUNCTION financial_report_balance_analytic_usd(integer, integer, date, date, integer, integer, text, integer);

CREATE OR REPLACE FUNCTION financial_report_balance_analytic_usd(report_id integer, fiscal_year integer, start_date date, end_date date, start_period_id integer, end_period_id integer, state_cond text, analytic_id integer)
  RETURNS numeric AS
$BODY$
  DECLARE
    balance numeric;
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_analytic_usd(integer, integer, date, date, integer, integer, text, integer)
  OWNER TO openerp;

  
-- Function: financial_report_balance_analytic_multicurrency_mmk(integer, integer, date, date, integer, integer, text, integer)

-- DROP FUNCTION financial_report_balance_analytic_multicurrency_mmk(integer, integer, date, date, integer, integer, text, integer);

CREATE OR REPLACE FUNCTION financial_report_balance_analytic_multicurrency_mmk(report_id integer, fiscal_year integer, start_date date, end_date date, start_period_id integer, end_period_id integer, state_cond text, analytic_id integer)
  RETURNS numeric AS
$BODY$
  DECLARE
    balance numeric;
    ...
    sql text :=   'select
                  ...
                  WHERE
                    ...
                    aml.move_id = account_move.id AND
                    period.fiscalyear_id = fiscalyear.id AND
                    aml.amount_currency > 0 and aml.currency_id = 120';
...
--     
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_analytic_multicurrency_mmk(integer, integer, date, date, integer, integer, text, integer)
  OWNER TO postgres;
  
  
  -- Function: financial_report_balance_analytic_multicurrency_euro(integer, integer, date, date, integer, integer, text, integer)

-- DROP FUNCTION financial_report_balance_analytic_multicurrency_euro(integer, integer, date, date, integer, integer, text, integer);

CREATE OR REPLACE FUNCTION financial_report_balance_analytic_multicurrency_euro(report_id integer, fiscal_year integer, start_date date, end_date date, start_period_id integer, end_period_id integer, state_cond text, analytic_id integer)
  RETURNS numeric AS
$BODY$
  DECLARE
    balance numeric;
    ...
    sql text :=   'select
                  ...
                  WHERE
                    ...
                    aml.move_id = account_move.id AND
                    period.fiscalyear_id = fiscalyear.id AND
                    aml.amount_currency > 0 and aml.currency_id = 1';
...
--     
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_analytic_multicurrency_euro(integer, integer, date, date, integer, integer, text, integer)
  OWNER TO postgres;
  
  
  -- Function: financial_report_balance_analytic_multicurrency_baht(integer, integer, date, date, integer, integer, text, integer)

-- DROP FUNCTION financial_report_balance_analytic_multicurrency_baht(integer, integer, date, date, integer, integer, text, integer);

CREATE OR REPLACE FUNCTION financial_report_balance_analytic_multicurrency_baht(report_id integer, fiscal_year integer, start_date date, end_date date, start_period_id integer, end_period_id integer, state_cond text, analytic_id integer)
  RETURNS numeric AS
$BODY$
  DECLARE
    balance numeric;
    ...
    sql text :=   'select
                  ...
                  WHERE
                    ...
                    aml.move_id = account_move.id AND
                    period.fiscalyear_id = fiscalyear.id AND
                    aml.amount_currency > 0 and aml.currency_id = 140';
...
--     
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_analytic_multicurrency_baht(integer, integer, date, date, integer, integer, text, integer)
  OWNER TO postgres;
