...
$BODY$
  ...
  COST 100;
ALTER FUNCTION financial_report_monthly_ksbalance(integer, integer, integer, text)
  OWNER TO postgres;
...
$BODY$
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_monthly_usdbalance(integer, integer, integer, text)
  OWNER TO postgres;
