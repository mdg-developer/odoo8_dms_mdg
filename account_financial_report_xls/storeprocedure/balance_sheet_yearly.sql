-- Function: financial_report_yearly_balance_sheet(integer, integer, integer, integer, text)

-- DROP FUNCTION financial_report_yearly_balance_sheet(integer, integer, integer, integer, text);

CREATE OR REPLACE FUNCTION financial_report_yearly_balance_sheet(report_id integer, fiscal_year integer, start_period_id integer, end_period_id integer, state_cond text)
  RETURNS numeric AS
$BODY$
  DECLARE
    balance numeric;
...
--     END IF;
  ...
  COST 100;
ALTER FUNCTION financial_report_yearly_balance_sheet(integer, integer, integer, integer, text)
  OWNER TO postgres;
