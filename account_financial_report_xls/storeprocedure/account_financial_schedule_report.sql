...
$BODY$
  ...
  BEGIN
    ...
    IF   start_date is not null and start_date > end_date  and end_date is not null THEN
  ...
  COST 100;
ALTER FUNCTION financial_report_balance(integer, integer, date, date, integer, integer, text)
  OWNER TO openerp;
...
$BODY$
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_ksamount(integer, integer, date, date, integer, integer, text)
  OWNER TO openerp;
...
$BODY$
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_ksamount_negative(integer, integer, date, date, integer, integer, text)
  OWNER TO postgres;
...
$BODY$
  ...
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION financial_report_balance_usdamount(integer, integer, date, date, integer, integer, text)
  OWNER TO openerp;
