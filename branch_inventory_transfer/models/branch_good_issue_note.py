...
class branch_good_issue_note(osv.osv):    
    ...
    def create_sale_order(self, cr, uid, ids, context=None):
        ...
        cr.execute("""insert into sale_order(name,partner_id,code,payment_type,payment_term,is_entry,section_id,date_order,payment_term,due_date,delivery_id,warehouse_id,
                   ...
                   (so_sequence,gin_value.partner_id.id,gin_value.customer_code,'credit',gin_value.partner_id.property_payment_term.id,True,gin_value.section_id.id,gin_value.issue_date,payment_term,datetime.now().date(),
