...
l.sub_total,c.name as sale_group ,s.m_status,s.type ,tp.name as township,r.village as village,ci.name as city,sc.name as channel, rs.name as state,s.delivery_remark ,s.additional_discount,s.void_flag,p.default_code as product_code,branch.name as branch,pm.name as main_group,pc.name as product_category
...
type,township,village ,city,channel, state,delivery_remark,additional_discount,sale_plan_day_name ,sale_plan_trip_name,void,product_code,branch,main_group,product_category)
...
data_record.township ,data_record.village,data_record.city,data_record.channel,
data_record.state,data_record.delivery_remark,data_record.additional_discount,'','',data_record.void_flag,data_record.product_code,data_record.branch,data_record.main_group,data_record.product_category);
end loop;
