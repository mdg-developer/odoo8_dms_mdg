...
header_fields = ['name_related', 'gender', 'marital', 'identification_id', 'mobile_phone', 'work_phone','blood_group','place_of_birth',
    'work_email', 'birthday', 'father_name','fingerprint_id','department_id','permanent_date','working_no'
    ...
    def import_data(self, cr, uid, ids, context=None):
        ...
        for ln in excel_rows:
            ...
            if not header_line:
                if ln[0].strip().lower() not in header_fields:
                    ...
                    header_line = True
                    status_i =blood_group_i = place_of_birth_i=permanent_date_i = permanent_salary_i = temporary_salary_i =name_related_i = gender_i = marital_i = identification_id_i = mobile_phone_i = work_phone_i = work_email_i = birthday_i= father_name_i = fingerprint_id_i = job_id_i = department_id_i = address_home_id_i = joining_date_i = education_i = other_qualification_i =working_no_i=working_experience_i=None
                    column_cnt = 0
                    ...
                    for i in range(column_cnt):
                        ...
                        # required header fields : account, debit, credit
                            ...
                            blood_group_i =i
                        elif header_field =='place_of_birth':
                            place_of_birth_i =i
                    ...
                    for f in [(blood_group_i,'blood_group'),(place_of_birth_i,'place_of_group'),(permanent_date_i,'permanent_date'),(permanent_salary_i,'permanent_salary'),(temporary_salary_i,'temporary_salary_i'),(name_related_i,'name_related'),(gender_i,'gender'),(marital_i,'marital'),(identification_id_i,'identification_id'),(mobile_phone_i,'mobile_phone'),(work_phone_i,'work_phone'),(work_email_i,'work_email'),(birthday_i,'birthday'),(father_name_i,'father_name'),(fingerprint_id_i,'fingerprint_id'),(working_no_i,'working_no'),(job_id_i,'job_id'),(department_id_i,'department_id'),(address_home_id_i,'address_home_id'),(joining_date_i,'joining_date'),(education_i,'education'),(other_qualification_i,'other_qualification'),(working_experience_i,'working_experience'),(status_i,'status')]:
                ...
                if ln and ln[0] and ln[0][0] not in ['#','']:
                    ...
                    import_vals['working_no'] = ln[working_no_i]
                    ...
                    import_vals['place_of_birth']=ln[place_of_birth_i]
        ...
        if err_log:
            ...
            for aml in amls:
                ...
                date_data = per_date = join_date =datetime.today()
                ...
                value={   'name':emp_name,
                          ...
                          'blood_group':aml['blood_group'],
                          'place_of_birth':aml['place_of_birth'],
                          'job_id' : job_name}
                if birthday:
                    try:
                ...
                value['working_no']=aml['working_no']
