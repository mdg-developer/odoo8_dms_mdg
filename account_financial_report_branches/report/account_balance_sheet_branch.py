...
class account_balance_sheet_branch(report_sxw.rml_parse, common_report_header):
    
    _name = 'report.account.account.balance.sheet.branch'
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(account_balance_sheet_branch, self).set_context(objects, data, new_ids, report_type=report_type)
    ...
    def __init__(self, cr, uid, name, context=None): 
        if context is None:
            context = {}
        super(account_balance_sheet_branch, self).__init__(cr, uid, name, context=context)
        self.query = ""
