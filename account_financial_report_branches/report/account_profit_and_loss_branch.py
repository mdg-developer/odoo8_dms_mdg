...
class account_profit_and_loss_branch(report_sxw.rml_parse, common_report_header):
    
    _name = 'report.account.account.profit.loss.branch'
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(account_profit_and_loss_branch, self).set_context(objects, data, new_ids, report_type=report_type)
