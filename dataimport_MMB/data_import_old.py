    ...
    def import_data(self, cr, uid, ids, context=None):
        ...
        for ln in excel_rows:
            ...
            if not header_line:
                if ln[0].strip().lower() not in header_fields:
                    ...
                    for f in [(permanent_date_i,'permanent_date'),(permanent_salary_i,'permanent_salary'),(temporary_salary_i,'temporary_salary_i'),(bank_account_id_i,'bank_account_id'),(name_related_i,'name_related'),(gender_i,'gender'),(marital_i,'marital'),(identification_id_i,'identification_id'),(mobile_phone_i,'mobile_phone'),(work_phone_i,'work_phone'),(work_email_i,'work_email'),(birthday_i,'birthday'),(father_name_i,'father_name'),(fingerprint_id_i,'fingerprint_id'),(job_id_i,'job_id'),(department_id_i,'department_id'),(address_home_id_i,'address_home_id'),(joining_date_i,'joining_date'),(education_i,'education'),(other_qualification_i,'other_qualification'),(working_experience_i,'working_experience'),(status_i,'status')]:
        ...
        if err_log:
            ...
            for aml in amls:
                ...
                if bank_ids:value['bank_account_id']=bank_ids
