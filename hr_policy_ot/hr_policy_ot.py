...
class policy_line_ot(osv.Model):
    ...
    _columns = {
        ...
        'type': fields.selection([('daily', 'Daily'),
                                 ...
                                 'Type', required=True),
        'ot_day':fields.selection([('0', 'Monday'),
                                  ('1', 'Tuesday'),
                                  ('2', 'Wednesday'),
                                  ('3', 'Thursday'),
                                  ('4','Friday'),
                                  ...
                                  ('6','Sunday')],
                                  'OT Day Specific'),
        'morning':fields.boolean('Morning OT'),
         ##### Developer
        #'rest_sun_day': fields.boolean('Not Calculate At Sunday'),
        #'rest_public_day': fields.boolean('Not Calculate At Public Holiday'),
        #'daily_not_calculate': fields.boolean('Not Calculate At Daily'),
        'specific_work_hr':fields.integer('Specific Working Hours'),
