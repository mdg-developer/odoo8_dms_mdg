...
""",
    ...
    'data': [       
        ...
        'wizard/generate_code_view.xml',
        'wizard/insert_sale_team_view.xml',
        'wizard/remove_sale_team_view.xml',
        'views/update_customer_data_view.xml',
        'data/customer_code_sequence.xml',
    ],
    'installable': True,
    'auto_install': False,
    'application': True,
