    ...
    def sync_to_cellar(self, cr, uid, ids, context=None):
        ...
        if data.name:
            ...
            if data.uom_id.name == 'Units':
                uom_id = [65]
            if data.uom_id.name == 'Pack':
                uom_id = [67]
            if data.uom_id.name == 'Pcs':
                uom_id = [68]
            if data.uom_id.name == 'Nos':
                uom_id = [69]
            if data.uom_id.name not in ['Units','Bottle','Pack','Pcs','Nos']:
            ...
            if not uom_id and data.uom_id.name not in ['Units','Bottle','Pack','Pcs','Nos']:
                value = {
