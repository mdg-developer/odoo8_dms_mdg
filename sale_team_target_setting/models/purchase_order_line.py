...
class product_template(osv.osv):
    ...
    def onchange_product_id(self, cr, uid, ids, pricelist_id, product_id, qty, uom_id,
        ...
        product_tmpl_id = product_product_obj.browse(cr, uid,product_id ).product_tmpl_id.id
        supplierinfo_ids = supplierinfo_obj.search(cr, uid, [('product_tmpl_id', '=', product_tmpl_id)])
        supplier_code = supplierinfo_obj.browse(cr, uid, supplierinfo_ids).name
        res['value'].update({'supplier_code': supplier_code.id,'supplier_name':supplier_code.name})
        print 'supplier_code>>',res
        return res