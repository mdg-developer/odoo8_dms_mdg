...
class stock_quant_package(osv.osv):
    ...
    _columns = {
        ...
        'stickering_process_chk': fields.boolean("Stickering Process Complete"),
        'repacking_process_chk': fields.boolean("Repacking Process Complete"),
        'strickering_state':fields.selection([('draft', 'Draft'), ('transfer', 'Transfer'), ('complete', 'Stickering Complete'), ('retransfer', 'Retransfer')], 'Status'),
    ...
    def retransfer(self, cr, uid, ids, context=None):
        move_obj = self.pool.get("stock.quant.package.stickering.move")
        move_items_obj = self.pool.get("stock.quant.package.stickering.move_items")         
        for data in self.browse(cr, uid, ids, context=context):
            ...
            if wizard_obj:
                ...
                self.write(cr, uid, ids, {'strickering_state':'retransfer'}, context=context)
        return True