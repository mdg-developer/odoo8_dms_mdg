...
class crm_case_section(osv.osv):
    ...
    _columns = {
                ...
                'total_invoice': fields.function(_get_total_invoice_data,
                type='float', readonly=True,
                string='Total Invoice'),
                'date':fields.date('Date'),
                'total_sku': fields.function(_get_total_sku_data,
                type='float', readonly=True,
                string='Total SKU'),
                 'total_sku_inv': fields.function(_get_total_sku_invoice_percent,
                type='float', readonly=True,
                string='Invoice/SKU %' ),          
                'total_sku': fields.function(_get_total_invoice_data,
                type='float', readonly=True,
                string='Total Invoice'),
                'date':fields.date('Date'),
                'total_rout_plan': fields.function(_get_total_rout_plan,
                type='float', readonly=True,
                string='Total Rout Plan'),           
                  'total_customer_visit': fields.function(_get_total_customer_visit,
                type='float', readonly=True,
                string='Total Customer Visit'),          
                    'total_pre_sale': fields.function(_get_total_pre_sale,
                type='float', readonly=True,
                string='Pre Order/Sale Order'),     
               'sale_value': fields.function(_get_sale_today,
                type='float', readonly=True,
                string='Sale Today'),       
                'sale_total_month': fields.function(_get_sale_month,
                type='float', readonly=True,
                string='Monthly Sale'),       
                'sale_confirm_today': fields.function(_get_sale_confirm,
                type='float', readonly=True,
                string='Sale Confirm Today'),                            
                'sale_work_day': fields.function(_get_sale_work,
                type='float', readonly=True,
                string='Sale WorkDay'),                           
                'sku_invoice': fields.function(_get_sku_invoice,
                type='float', readonly=True,
                string='SKU/Invoice'),       
                'product_invoice': fields.function(_get_product_invoice,
                type='float', readonly=True,
                string='Daily Average'),  
                'credit_sale': fields.function(_get_credit_sale,
                type='float', readonly=True,
