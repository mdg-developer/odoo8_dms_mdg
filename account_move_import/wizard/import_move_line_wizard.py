...
header_fields = ['account', 'debit', 'credit', 'name', 'partner', 'date_effective','date_maturity',
        ...
        for ln in reader:
            ...
            if not header_line:
                if ln[0].strip().lower() not in header_fields:
                    ...
                    column_cnt = 0
                    account_i = debit_i = credit_i = name_i = partner_i = date_maturity_i = date_effective_i = amount_currency_i = currency_i = tax_code_i = tax_amount_i = analytic_i = None
                    ...
                    for i in range(column_cnt):
                        ...
                        # optional header fields
                            ...
                            date_maturity_i = i
                        elif header_field == 'date_effective_i':
                            date_effective_i = i
            ...
            # process data lines
                ...
                if ln and ln[0] and ln[0][0] not in ['#','']:
                    ...
                    if isinstance(date_effective_i, int) and ln[date_effective_i]:
                        aml_vals['date_created'] = ln[date_effective_i]
