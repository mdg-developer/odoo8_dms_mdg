-- select * from insert_daily_customer_target_tmw();
-- DROP FUNCTION insert_daily_customer_target_tmw();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_tmw()
  RETURNS void AS
$BODY$
