-- select * from insert_daily_customer_target_myw();
-- DROP FUNCTION insert_daily_customer_target_myw();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_myw()
  RETURNS void AS
$BODY$
