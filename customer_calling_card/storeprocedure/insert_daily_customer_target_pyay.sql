-- select * from insert_daily_customer_target_pyay();
-- DROP FUNCTION insert_daily_customer_target_pyay();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_pyay()
  RETURNS void AS
$BODY$
