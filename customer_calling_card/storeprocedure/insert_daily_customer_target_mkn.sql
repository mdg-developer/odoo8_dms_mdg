-- select * from insert_daily_customer_target_mkn();
-- DROP FUNCTION insert_daily_customer_target_mkn();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_mkn()
  RETURNS void AS
$BODY$
