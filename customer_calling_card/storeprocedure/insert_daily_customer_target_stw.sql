-- select * from insert_daily_customer_target_stw();
-- DROP FUNCTION insert_daily_customer_target_stw();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_stw()
  RETURNS void AS
$BODY$
