-- select * from insert_daily_customer_target_lsd_tty();
-- DROP FUNCTION insert_daily_customer_target_lsd_tty();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_lsd_tty()
  RETURNS void AS
$BODY$
