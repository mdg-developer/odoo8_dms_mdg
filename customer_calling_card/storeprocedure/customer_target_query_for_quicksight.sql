...
select rp.name customer,pp.name_template product,uom.name uom,ach_qty,target_qty,gap_qty,
...
(
	...
	from target_line tl		
)AAA,res_partner rp,product_product pp,product_uom uom
where AAA.partner_id=rp.id
and AAA.product_id=pp.id	
and AAA.uom_id=uom.id;