-- select * from insert_daily_customer_target_mdy();
-- DROP FUNCTION insert_daily_customer_target_mdy();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_mdy()
  RETURNS void AS
$BODY$
