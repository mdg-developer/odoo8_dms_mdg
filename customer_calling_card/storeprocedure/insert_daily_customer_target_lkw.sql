-- select * from insert_daily_customer_target_lkw();
-- DROP FUNCTION insert_daily_customer_target_lkw();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_lkw()
  RETURNS void AS
$BODY$
