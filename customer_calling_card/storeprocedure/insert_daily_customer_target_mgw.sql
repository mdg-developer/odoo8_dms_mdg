-- select * from insert_daily_customer_target_mgw();
-- DROP FUNCTION insert_daily_customer_target_mgw();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_mgw()
  RETURNS void AS
$BODY$
