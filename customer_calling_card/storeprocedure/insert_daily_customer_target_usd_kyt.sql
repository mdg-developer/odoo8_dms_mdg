-- select * from insert_daily_customer_target_usd_kyt();
-- DROP FUNCTION insert_daily_customer_target_usd_kyt();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_usd_kyt()
  RETURNS void AS
$BODY$
