-- select * from insert_daily_customer_target_mtl();
-- DROP FUNCTION insert_daily_customer_target_mtl();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_mtl()
  RETURNS void AS
$BODY$
