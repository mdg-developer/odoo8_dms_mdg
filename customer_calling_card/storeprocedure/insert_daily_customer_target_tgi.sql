-- select * from insert_daily_customer_target_tgi();
-- DROP FUNCTION insert_daily_customer_target_tgi();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_tgi()
  RETURNS void AS
$BODY$
