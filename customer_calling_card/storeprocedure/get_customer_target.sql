--select * from get_customer_target(182553)
					...
					(	select *,
						...
						(	select *,
							...
							(	select *,
								...
								((select  COALESCE((amt.inv_total_amt),0) from invoice_amt amt where amt.partner_id =BB.partner_id)/divisor)as ams_value,
