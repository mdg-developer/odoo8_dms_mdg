-- select * from insert_daily_customer_target_umsd();
-- DROP FUNCTION insert_daily_customer_target_umsd();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_umsd()
  RETURNS void AS
$BODY$
