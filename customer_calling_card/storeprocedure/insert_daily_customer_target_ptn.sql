-- select * from insert_daily_customer_target_ptn();
-- DROP FUNCTION insert_daily_customer_target_ptn();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_ptn()
  RETURNS void AS
$BODY$
