-- select * from insert_daily_customer_target_npt();
-- DROP FUNCTION insert_daily_customer_target_npt();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_npt()
  RETURNS void AS
$BODY$
