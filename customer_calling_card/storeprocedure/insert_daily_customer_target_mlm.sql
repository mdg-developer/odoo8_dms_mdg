-- select * from insert_daily_customer_target_mlm();
-- DROP FUNCTION insert_daily_customer_target_mlm();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_mlm()
  RETURNS void AS
$BODY$
