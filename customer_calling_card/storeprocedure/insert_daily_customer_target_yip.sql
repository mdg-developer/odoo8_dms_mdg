-- select * from insert_daily_customer_target_yip();
-- DROP FUNCTION insert_daily_customer_target_yip();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_yip()
  RETURNS void AS
$BODY$
