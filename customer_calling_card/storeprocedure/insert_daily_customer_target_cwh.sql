-- select * from insert_daily_customer_target_cwh();
-- DROP FUNCTION insert_daily_customer_target_cwh();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_cwh()
  RETURNS void AS
$BODY$
