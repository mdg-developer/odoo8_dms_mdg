-- select * from insert_daily_customer_target_lso();
-- DROP FUNCTION insert_daily_customer_target_lso();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_lso()
  RETURNS void AS
$BODY$
