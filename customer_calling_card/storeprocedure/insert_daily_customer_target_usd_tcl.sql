-- select * from insert_daily_customer_target_usd_tcl();
-- DROP FUNCTION insert_daily_customer_target_usd_tcl();

CREATE OR REPLACE FUNCTION insert_daily_customer_target_usd_tcl()
  RETURNS void AS
$BODY$
