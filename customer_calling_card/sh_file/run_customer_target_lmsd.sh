...
psql -h mdgtest.ctwxzwpgho6b.ap-southeast-1.rds.amazonaws.com -p 5432 -U odoo -d mdg_uat -c "select * from insert_daily_customer_target_lmsd();"  > /root/scripts/target_update.log
