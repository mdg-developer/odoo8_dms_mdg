        ...
        for partner in self.pool.get('res.partner').browse(cr, uid, partner_lists, context=None):
            ...
            if customer_wcapi and partner.woo_customer_id:
                ...
                if partner.mobile:
                    ...
                    customer_data = {
                                        "user_id": str(woo_customer_id),
                                        "update_phone": partner.mobile
                                    }
                    customer_response = customer_wcapi.post('wp-json/auth-api/v1/odoo/users/phone_number_update', customer_data)
