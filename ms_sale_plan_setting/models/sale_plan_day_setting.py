...
class sale_plan_setting_line(osv.osv):  # #prod_pricelist_update_line
    ...
    _columns = {                
        ...
        'w1_mon':fields.boolean('D1 MON'),
        'w1_tue':fields.boolean('D1 TUE'),
        'w1_wed':fields.boolean('D1 WED'),
        'w1_thur':fields.boolean('D1 THU'),
        'w1_fri':fields.boolean('D1 FRI'),
        'w1_sat':fields.boolean('D1 SAT'),
        'w2_mon':fields.boolean('D2 MON'),
        'w2_tue':fields.boolean('D2 TUE'),
        'w2_wed':fields.boolean('D2 WED'),
        'w2_thur':fields.boolean('D2 THU'),
        'w2_fri':fields.boolean('D2 FRI'),
        'w2_sat':fields.boolean('D2 SAT'),
        'w3_mon':fields.boolean('D3 MON'),
        'w3_tue':fields.boolean('D3 TUE'),
        'w3_wed':fields.boolean('D3 WED'),
        'w3_thur':fields.boolean('D3 THU'),
        'w3_fri':fields.boolean('D3 FRI'),
        'w3_sat':fields.boolean('D3 SAT'),
        'w4_mon':fields.boolean('D4 MON'),
        'w4_tue':fields.boolean('D4 TUE'),
        'w4_wed':fields.boolean('D4 WED'),
        'w4_thur':fields.boolean('D4 THU'),
        'w4_fri':fields.boolean('D4 FRI'),
        'w4_sat':fields.boolean('D4 SAT'),
    }
